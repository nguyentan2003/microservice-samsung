...
public class PendingMessageProcessor {
    ...
    public void processPendingMessages() {
        ...
        for (PendingMessage msg : list) {
            try {
                CustomerSummary cs = customerSummaryRepository
                        .findByOrderId(msg.getOrderId())
                        .orElse(null);
                if (cs == null) {
                ...
                switch (msg.getType()) {
                    ...
                    case Topic.ORDER_PRODUCT_DATA:
                        var dataProduct = objectMapper.convertValue(
                                msg.getPayload(), com.samsung.event.dto.DataOrderProduct.class);
                        Update updateProduct = new Update()
                                .set("orderItemSummaries", dataProduct.getOrderItemProducts())
                                .set("updatedAt", LocalDateTime.now());
                        mongoTemplate.updateFirst(
                                new Query(Criteria.where("orderId").is(dataProduct.getOrderId())),
                                updateProduct,
                    ...
                    case Topic.PUSH_DATA_INFO_ORDER_CREATED:
                        var dataUserInfo =
                                objectMapper.convertValue(msg.getPayload(), com.samsung.event.dto.DataUserInfo.class);
                        Update updateUserInfo = new Update()
                                ...
                                .set("updatedAt", LocalDateTime.now());
                        mongoTemplate.updateFirst(
                                new Query(Criteria.where("orderId").is(dataUserInfo.getOrderId())),
                                updateUserInfo,
                                CustomerSummary.class);
                    ...
                    case Topic.DATA_PAYMENT_SUCCESS:
                        var dataPayment =
                                objectMapper.convertValue(msg.getPayload(), com.samsung.event.dto.DataPayment.class);
                        Update updatePayment = new Update()
                                ...
                                .set("updatedAt", LocalDateTime.now());
                        mongoTemplate.updateFirst(
                                new Query(Criteria.where("orderId").is(dataPayment.getOrderId())),
                                updatePayment,
                                CustomerSummary.class);
                    ...
                    case Topic.REFUND_MONEY:
                        ...
                        Update updateRefund = new Update()
                                ...
                                .set("updatedAt", LocalDateTime.now());
                        mongoTemplate.updateFirst(
                                new Query(Criteria.where("orderId").is(refundOrderId)),
                                updateRefund,
                                CustomerSummary.class);
                    ...
                    case Topic.PAYMENT_FAILED:
                        ...
                        Update updateFailed = new Update()
                                ...
                                .set("updatedAt", LocalDateTime.now());
                        mongoTemplate.updateFirst(
                                new Query(Criteria.where("orderId").is(failedOrderId)),
                                updateFailed,
                                CustomerSummary.class);
                    ...
                    case Topic.ORDER_STOCK_RESERVED:
                        ...
                        Update updateStockReserved = new Update()
                                ...
                                .set("updatedAt", LocalDateTime.now());
                        mongoTemplate.updateFirst(
                                new Query(Criteria.where("orderId").is(reservedOrderId)),
                                updateStockReserved,
                                CustomerSummary.class);
                    ...
                    case Topic.RETURN_STOCK:
                        ...
                        Update updateReturnStock = new Update()
                                ...
                                .set("updatedAt", LocalDateTime.now());
                        mongoTemplate.updateFirst(
                                new Query(Criteria.where("orderId").is(returnOrderId)),
                                updateReturnStock,
                                CustomerSummary.class);
                    ...
                    case Topic.ORDER_STOCK_FAILED:
                        ...
                        Update updateStockFailed = new Update()
                                ...
                                .set("updatedAt", LocalDateTime.now());
                        mongoTemplate.updateFirst(
                                new Query(Criteria.where("orderId").is(stockFailedOrderId)),
                                updateStockFailed,
                                CustomerSummary.class);
                    ...
                    case Topic.ORDER_SUCCESS:
                        var dataOrderSuccess =
                                objectMapper.convertValue(msg.getPayload(), com.samsung.event.dto.DataOrder.class);
                        Update updateOrderSuccess = new Update()
                                .set("orderStatus", OrderStatus.SUCCESS)
                                .set("updatedAt", LocalDateTime.now());
                        mongoTemplate.updateFirst(
                                new Query(Criteria.where("orderId").is(dataOrderSuccess.getId())),
                                updateOrderSuccess,
                                CustomerSummary.class);
                    ...
                    case Topic.ORDER_CANCELED:
                        var dataOrderCanceled =
                                objectMapper.convertValue(msg.getPayload(), com.samsung.event.dto.DataOrder.class);
                        Update updateOrderCanceled = new Update()
                                .set("orderStatus", OrderStatus.CANCELED)
                                .set("updatedAt", LocalDateTime.now());
                        mongoTemplate.updateFirst(
                                new Query(Criteria.where("orderId").is(dataOrderCanceled.getId())),
                                updateOrderCanceled,
                                CustomerSummary.class);
                ...
                log.error(
                        "❌ Retry thất bại message={} orderId={} - {}", msg.getType(), msg.getOrderId(), e.getMessage());
            }
        }
    }
}
