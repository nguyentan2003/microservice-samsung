...
useEffect(() => {
        ...
        const logoutButton = document.querySelector(".information-btn .btn__logout");
    const fixInfoButton = document.querySelector(".information-btn .btn__fixInfo");
...
eventSource.onerror = (err) => {
      ...
      eventSource.close();
            ...
            return (
    <div className={`header__information-float ${showInfo ? "active" : ""}`}>
      <div className="information-float__top">
        <img src={user.avatar} alt="avatar" />
      </div>{" "}
      <div className="information-float__bottom">
        <div className="information-value">
          <span className="information-value__name"> {user.name} </span>{" "}
          <span className="information-value__gmail"> {user.email} </span>{" "}
