...
public class Topic {
    public static final String ORDER_CREATED = "OrderCreated2";
    public static final String CUSTOMER_SUMMARY_ORDER_CREATED = "CustomerSummaryOrderCreated";
    ...
    public static final String ORDER_STOCK_FAILED = "OrderStockFailed";
